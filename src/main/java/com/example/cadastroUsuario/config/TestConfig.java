...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// sdf.parse("13/05/1996"));
		// User u2 = new User(null, "Alex Green", "alex@gmail.com", 9777766L,
		// sdf.parse("15/06/1998"));

		// Address a1 = new Address(null, "Raimundo Aexandre", 190, "próximo ao
		// Chama2","Paraíso 4", "Naviraí", "MS", 79950000L, u1);
		// Address a2 = new Address(null, "José Bonifácio", 550, "próximo ao
		// Senai","Centro", "Naviraí", "MS", 79950000L, u1);
